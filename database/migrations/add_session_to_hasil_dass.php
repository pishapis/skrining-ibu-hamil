...
// database/migrations/xxxx_add_session_to_hasil_dass.php
...
return new class extends Migration {
    public function up(): void {
        Schema::table('hasil_dass', function (Blueprint $table) {
            // jika dass_id saat ini NOT NULL, ubah jadi nullable
            $table->unsignedBigInteger('dass_id')->nullable()->change();
            ...
            $table->unique(['session_token','dass_id']);
        });
    }

    public function down(): void {
        Schema::table('hasil_dass', function (Blueprint $table) {
            $table->dropUnique(['session_token','dass_id']);
