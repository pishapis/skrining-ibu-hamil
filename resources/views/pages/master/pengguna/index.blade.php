...
<x-app-layout title="Manajemen Pengguna | Skrining Ibu Hamil">
    ...
    <div x-data="{ tab: '{{ request('tab','ibu') }}' }"
        ...
        <div class="grid grid-cols-6 gap-3 items-center">
            ...
            <button type="button" 
                @click.prevent="$dispatch('open-modal', tab === 'ibu' ? 'modal-register-ibu' : 'modal-register-puskesmas')"
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-xs">
                                <a href="#"
                                    @click.prevent="openEditPengguna('ibu', {
                                       id: {{ $item->id }},
                                       ...
                                       tanggal_lahir: @js(date($item->tanggal_lahir)),
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-xs">
                                <a href="#"
                                    @click.prevent="openEditPengguna('puskesmas', {
                                       id: {{ $item->id }},
                                       user_id: {{ $item->user_id }},
                                       nama: @js($item->nama),
                                       nik: @js($item->nik),
    ...
    {{-- ===================== MODAL (JETSTREAM) ===================== --}}
    <x-modal name="data-pengguna" focusable>
        {{-- Fallback S agar semua binding aman walau store belum siap --}}
        <div id="editModalPengguna" class="p-4"
            ...
            <form x-show="S.type === 'ibu'" x-cloak data-swup-form 
                ...
                @method('POST')
                @csrf 
                <input type="hidden" name="user_id" x-model="S.form.user_id"/>
    ...
    <x-modal name="modal-register-ibu" focusable>
        <div class="p-8">
        ...
        <script data-swup-reload-script>
            ...
            (function() {
                ...
                function installStore() {
                    if (Alpine.store('editUser')) return;
                    ...
                    window.openEditPengguna = function(type, item) {
                        ...
                        setTimeout(() => {
                            ...
                            if (f.kec_id) window.filterKels(f.kec_id, f.kelurahan_id);
                            if (f.kota_id) window.filterFaskesRujukans(f.kota_id, f.faskes_rujukan_id);
                        }, 0);
                ...
                function getModalRoot() {
                    return document.getElementById('editModalPengguna') || document;
                }
                ...
                async function filterKels(kecId, selectedValue = null) {
                    try {
                ...
                async function filterFaskesRujukans(kotaId, selectedValue = null) {
                    try {
