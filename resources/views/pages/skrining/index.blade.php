<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        <div id="form-skrining" class="mt-6 pb-24 md:pb-0 max-w-3xl mx-auto" style="display:none;">
            ...
            <!-- <div class="fixed md:static bottom-0 left-0 right-0 z-50 bg-white/90 supports-[backdrop-filter]:bg-white/70 backdrop-blur border-t"
  ...
  `;
                ...
                (q.answers || []).forEach(ans => {
                    ...
                    // Preselect jika sudah ada di state (mis. saat resume)
                    ...
                    // Aksesibilitas: jika user fokus ke input lalu tekan spasi/enter (change event)
